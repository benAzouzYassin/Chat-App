...
export default function SidebarItem(props: Props) {
    ...
    return <div className="w-full  h-[100px]  border-b-2 hover:bg-[#e9e9e9] hover:cursor-pointer rounded-2xl flex flex-row " style={{ backgroundColor: bgColor }} onClick={() => props.updateSelectedUser!(props.userId)}>
